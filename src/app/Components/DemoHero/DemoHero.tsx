        ...
        <div className={styles.imageColumn}>
          <div className={styles.cardsContainer}>
            <div className={styles.card1}>
              <div className={styles.cardHeader}>
                <span className={styles.cardIcon}>📈</span>
                <span className={styles.cardTitle}>Market Growth</span>
              </div>
              <p className={styles.cardValue}>$2.8M</p>
              <p className={styles.cardChange}>+ 8.4% this year</p>
            </div>
            <div className={styles.card2}>
              <div className={styles.cardHeader}>
                <span className={styles.cardIcon}>🎯</span>
                <span className={styles.cardTitle}>Target Achieved</span>
              </div>
              <p className={styles.cardValue}>92%</p>
              <p className={styles.cardChange}>+ 3.5% vs last year</p>
            </div>
            <div className={styles.card3}>
              <div className={styles.cardGraph}>
                <p>Market Trends</p>
